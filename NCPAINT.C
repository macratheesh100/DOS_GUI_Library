...
void main()
{
 ...
 UCHAR *Edit_Menu[]={"Undo","Redo","-","Cut","Copy","Paste"};
 ...
 int MENU_EDIT_ACTIVE[6]={FALSE,FALSE,FALSE,FALSE,FALSE,FALSE};
...
void Main_Window(char *txt)
{
 ...
 TITLE1.x1=MaxX-5;
 TITLE1.y1=MaxY-5;
 INIT_Window(TITLE1.x,TITLE1.y,TITLE1.x1,TITLE1.y1,"NCPaint : Developed By NCCT Team");
